...
export const compactButtonClass =
  'inline-flex min-w-0 cursor-pointer items-center justify-center border-2 px-4 pt-[calc(0.5rem+0.5px)] pb-[calc(0.5rem-0.5px)] text-sm font-bold uppercase tracking-[0.05em] transition-all duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-paper'
...
export const tagClass =
  'border-2 border-stroke bg-panel px-2.5 pt-[calc(0.25rem+0.5px)] pb-[calc(0.25rem-0.5px)] font-mono text-[0.7rem] uppercase tracking-[0.15em] text-ink'

export const tagCompactClass =
  'border border-stroke bg-panel px-2 pt-[calc(0.125rem+0.5px)] pb-[calc(0.125rem-0.5px)] font-mono text-[0.62rem] uppercase tracking-[0.1em] text-ink'
