      ...
      <div className="mx-auto flex min-h-screen max-w-350 flex-col border-x-2 border-stroke bg-paper">
        <header className="grid gap-6 border-b-2 border-stroke p-5 md:p-8 lg:grid-cols-[minmax(0,1fr)_minmax(22rem,30rem)] lg:items-start xl:grid-cols-[minmax(0,1fr)_minmax(24rem,32rem)]">
          <div className="grid gap-4">
            ...
            <div className="max-w-120">
              ...
              <p className="mt-4 max-w-[48ch] text-[1.05rem] leading-relaxed text-ink-soft">
                Building production systems where backend depth meets frontend clarity.
              </p>
            </div>
          </div>
        ...
        <footer className="grid gap-6 border-t-2 border-stroke p-5 md:p-8 text-sm leading-relaxed text-ink-soft lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] lg:items-start bg-surface">
          <p className="max-w-[30ch]">
            Polyglot builds with production discipline. Open source by default.
          </p>
